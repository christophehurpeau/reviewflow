...
* use pr title when body no longer have the checkbox ([0b56dd2](https://github.com/christophehurpeau/reviewflow/commit/0b56dd2))
...
* update valerian's login ([e4d70a4](https://github.com/christophehurpeau/reviewflow/commit/e4d70a4))
...
* remove automerge from queue if case is unchecked ([8601e00](https://github.com/christophehurpeau/reviewflow/commit/8601e00))
* skipAutoMerge when edittOpenedPR already call the method ([241fb0d](https://github.com/christophehurpeau/reviewflow/commit/241fb0d))
...
* bring back automerge on open ([8b5fcb9](https://github.com/christophehurpeau/reviewflow/commit/8b5fcb9))
* dont ignore renovate edits on prs ([a24e13e](https://github.com/christophehurpeau/reviewflow/commit/a24e13e))

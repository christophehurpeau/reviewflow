...
async function createApi(octokitApp, accessToken) {
...
const getUser = async (req, res, octokit) => {
...
function auth(router, octokitApp) {
...
function home(router, octokitApp) {

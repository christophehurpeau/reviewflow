...
export declare type GroupLabels = 'needsReview' | 'requested' | 'changesRequested' | 'approved';
export declare type CiLabels = 'inProgress' | 'succeeded' | 'failed';
export declare type ReviewConfig<GroupNames extends string> = Record<GroupNames, Record<GroupLabels, string>> & Record<'ci', Record<CiLabels, string>>;
